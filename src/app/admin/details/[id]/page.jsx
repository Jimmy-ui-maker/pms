      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Admin details section</li>
          </ol>
        </nav>
      </div>
      {/**<!-- End Page Title --> */}
      <section className=" admdetalsPage">
            ...
            <div className="col-lg-12 col-12 p-2 ">
              <div className="card p-2  ">
                ...
                <div className=" flex4 text-start p-2">
                  ...
                  <p>{kads.desc}</p>
                  <p>
                    To see more details about our Organization, visit our
                    website link <Link href={"/"}>ktc.com</Link>. Thank You.
                  </p>
                </div>
