...
export default async function page() {
  ...
  return (
    <main id="main" class="main">
      ...
      {/**<!-- End Page Title --> */}
      <section id="report" class="placementList min-vh-100 section-bg pb-4">
        <div class="container" data-aos="fade-up">
          <div class="section-title ">
            <h2 className=" text-center fw-bold  text-uppercase">
              List of Placement Industries
            </h2>
          ...
          <div class="row">
            <div className=" mb-3  d-flex justify-content-center align-items-center">
              <Link className=" btn border-0 shadow-lg " href={"/students/addRecords"}>
              ...
              >
                <div class="organization d-flex align-items-start">
                  ...
                  <div class="organization-info">
                    ...
                    <p>{kad.state} State.</p>
                    <div class="links">
                      <Link href={"/admin/details/" + kad._id}>
                        <i class="bi bi-eye"></i>
                      </Link>
                      <Link href="">
                        <i class="bi bi-"></i>
