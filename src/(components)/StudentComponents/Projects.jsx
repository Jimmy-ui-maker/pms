...
export default function Projects() {
  return (
    <section
      id="projects"
      className="projects min-vh-100 pb-4 d-flex flex-column justify-content-center align-items-center"
    >
      <div className="container">
        ...
        <div className="row g-4 text-center  align-items-center">
          ...
          <div className="col-12 col-lg-3 ">
            <div className="card2 ">
              <Link className=" text-decoration-none" href={"/students/projects"}>
                Click for more
              </Link>
            </div>
          </div>
